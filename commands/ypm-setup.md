...
so you can use /ypm-update instead of /ypm:ypm-update
```

**Options**:
1. **Yes** - Create links (commands available as /ypm, /ypm-update, etc.)
2. **No** - Keep prefix (commands available as /ypm:ypm, /ypm:ypm-update, etc.)
...
2. Run your first scan: /ypm:ypm-update (or /ypm-update if linked)
